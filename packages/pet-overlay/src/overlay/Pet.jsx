...
export default function Pet({ stage = 0, face = 'idle' }) {
  return (
    <svg className="pet-svg" viewBox="0 0 100 106" width="100" height="106" aria-hidden>
      ...
      <path
        className="tail"
        d="M68 86 q24 3 20 -20 q-3 -13 -13 -9 q10 3 6 15 q-3 9 -15 6 z"
        fill="#fff"
        stroke="#cdd6e6"
        strokeWidth="1.4"
      />
      ...
      {stage >= 2 && (
        <path
          d="M32 63 Q14 74 20 99 L80 99 Q86 74 68 63 Q50 71 32 63 Z"
          fill="#7b46e0"
          stroke="#5b32b0"
          strokeWidth="1.3"
      ...
      <path
        d="M16 30 C 16 14, 20 6, 26 4 C 32 6, 38 16, 45 27 C 34 30, 23 32, 16 30 Z"
        fill="#fff"
        stroke="#cdd6e6"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M84 30 C 84 14, 80 6, 74 4 C 68 6, 62 16, 55 27 C 66 30, 77 32, 84 30 Z"
        fill="#fff"
        stroke="#cdd6e6"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M23 28 C 23 17, 26 11, 29 10 C 33 13, 37 20, 41 27 C 33 29, 27 30, 23 28 Z"
        fill="#ffb3d1"
      />
      <path
        d="M77 28 C 77 17, 74 11, 71 10 C 67 13, 63 20, 59 27 C 67 29, 73 30, 77 28 Z"
        fill="#ffb3d1"
      />
      {/* 머리 (귀 아래를 덮어 자연스럽게) */}
      ...
      {face === 'happy' ? (
        ...
        <path
          d="M50 55.5 q-3 3 -6 1 M50 55.5 q3 3 6 1"
          fill="none"
          stroke="#3a3f4b"
          strokeWidth="1.5"
          strokeLinecap="round"
      ...
      {stage >= 1 && (
        <g>
          <path
            d="M34 22 Q46 0 61 -3 Q66 7 59 13 L60 22 Z"
            fill="#8a5cf6"
            stroke="#5b32b0"
            strokeWidth="1.3"
            strokeLinejoin="round"
          ...
          />
          <path
            d="M49 5 l1.6 3.3 3.6.5-2.6 2.5.6 3.6-3.2-1.7-3.2 1.7.6-3.6-2.6-2.5 3.6-.5z"
            fill="#ffd35a"
          />
        </g>
      )}
